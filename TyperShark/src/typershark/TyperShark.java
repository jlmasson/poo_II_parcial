...
public class TyperShark extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        * **/
        root.setStyle("-fx-background-image: url(images/background/fondo.jpg)");
        root.setAlignment(Pos.CENTER);
        botonPrueba.getStyleClass().add("boton");
        botonPrueba.setOnAction(new ClickHandler1(primaryStage));
        ...
        * ***/
        ...
        Image applicationIcon = new Image(TyperShark.class.getClassLoader().getResource("images/title/icono.png").toExternalForm());
    ...
    private class ClickHandler1 implements EventHandler<ActionEvent> {
        ...
        public ClickHandler1(Stage primary) {
            stage = primary;
        }
