...
/**
 * Esta clase define objetos de tipo Pulpo que es subclase de la
 * superclase AnimalMarino.
 * @author: Galo Castillo, Danilo Torres
 * @version: 4.0 19/9/2016
 */
public class Pulpo extends AnimalMarino {
    ...
    public Pulpo(Mar mar, ArrayList<String> palabrasJuego) {
        super(mar, "images/components/pulpo.png", palabrasJuego,
